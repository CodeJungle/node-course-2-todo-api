...
describe('GET /todos/:id', () => {
  it('should return a todo created by the user', (done) => {
    request(app)
...
describe('DELETE /todos/:id', () => {
  it('should remove a todo created by the user', (done) => {
...
describe('PATCH /todos/:id', () => {
  it('should update a todo created by the user', (done) => {
    var hexId = todos[0]._id.toHexString();
    var text = 'Test first text changed';
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    var hexId = todos[1]._id.toHexString();
    var text = 'Test second text changed';
